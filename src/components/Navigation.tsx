...
export const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-xl border-b border-gold/20 shadow-luxury">
      <div className="container mx-auto px-8 py-6">
        <div className="flex items-center justify-between">
          ...
          <button onClick={goToHome} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            <div className="w-8 h-8 bg-gradient-gold flex items-center justify-center">
              <div className="w-4 h-4 border-2 border-foreground rotate-45" />
            </div>
          ...
          <div className="hidden md:flex items-center gap-10">
            <button
              ...
              className="relative text-sm font-sans tracking-[0.2em] uppercase hover:text-gold transition-all duration-300 group"
            >
              {t("navAbout")}
        ...
        <div className={`md:hidden overflow-hidden transition-all duration-300 ${mobileMenuOpen ? 'max-h-96 mt-6' : 'max-h-0'}`}>
          <div className="flex flex-col gap-6 pb-6 border-t border-gold/20 pt-6">
            <button
              onClick={() => scrollToSection("about")}
              className="text-left text-sm font-sans tracking-[0.2em] uppercase hover:text-gold transition-all duration-300"
            >
              {t("navAbout")}
            </button>
            <button
