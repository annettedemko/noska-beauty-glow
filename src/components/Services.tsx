      ...
      <div className="container max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-24 space-y-8">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Premium Permanent Make-up Services
          </p>
        </div>
        ...
        <div className="grid gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="group relative bg-background/60 backdrop-blur-sm border border-gold/20 hover:border-gold/40 transition-all duration-500 hover-lift shadow-luxury overflow-hidden"
            >
              {/* Gold accent bar */}
              ...
              <div className="absolute top-0 right-0 w-20 h-20 overflow-hidden opacity-20">
                <div className="absolute top-0 right-0 w-full h-full bg-gradient-gold transform rotate-45 translate-x-10 -translate-y-10" />
              </div>
            </div>
          ))}
        </div>
