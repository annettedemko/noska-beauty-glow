...
const translations = {
  DE: {
    ...
    price300: "250/350 €",
    price100: "100 €",
    price50percent: "50% des Erstbehandlungspreises",
    price120: "120 €",
    priceCamouflage: "150/250/350 €",
    camouflageNote: "150 € kleine Zone · 250 € mittlere Zone · 350 € große Zone",
    correctionNote: "Korrektur nach 4-6 Wochen: 50% vom Erstbehandlungspreis",
    correctionNoteShort: "Korrektur nach 4-6 Wochen",
    ...
    contactEmail: "Email",
    address: "Englmannstraße 2, Büro 1A, 81673 München",
    contactTreatment: "Behandlungen nach Terminvereinbarung",
    contactPostal: "Postanschrift",
    postalAddress: "Aubinger Straße 147, 81243 München",
    instagram: "Instagram",
    ...
    scalpPrice: "Preis: 250/350 €",
    scalpPriceNote: "250 € mittlere Zone · 350 € große Zone",
    ...
    scalpSeoText2: "Die Trichopigmentierung ist eine spezielle Form des Permanent Make-ups, bei der winzige Pigmentpunkte in die oberste Hautschicht der Kopfhaut eingebracht werden. Diese imitieren die natürlichen Haarfollikel und erzeugen optisch den Eindruck von dichterem Haar oder einer rasierten Frisur. Die Behandlung ist besonders effektiv bei Geheimratsecken, lichtem Haar, Narben von Haartransplantationen oder bei Alopecia areata. Im Gegensatz zu einer Haartransplantation ist die Kopfhautpigmentierung in der Regel gut verträglich; das Schmerzempfinden kann individuell variieren. Die Behandlung erfordert keine Erholungszeit. Das Ergebnis ist sofort sichtbar und hält mehrere Jahre. Vereinbaren Sie jetzt Ihren Beratungstermin in München und erfahren Sie, wie Trichopigmentierung auch Ihnen helfen kann.",
    ...
    camouflagePrice: "Preis: 150/250/350 €",
    camouflagePriceNote: "150 € kleine Zone · 250 € mittlere Zone · 350 € große Zone",
    ...
    touchupServiceBrowsPrice: "50% des Erstbehandlungspreises",
    touchupServiceLips: "Aquarell / Velvet / Ombre Lippen",
    touchupServiceLipsPrice: "50% des Erstbehandlungspreises",
    touchupServiceScalp: "Kopfhaut Pigmentierung",
    touchupServiceScalpPrice: "50% des Erstbehandlungspreises",
    touchupServiceCamouflage: "Camouflage",
    touchupServiceCamouflagePrice: "50% des Erstbehandlungspreises",
  ...
  RU: {
    ...
    price300: "250/350 €",
    price100: "100 €",
    price50percent: "50% от стоимости процедуры",
    price120: "120 €",
    priceCamouflage: "150/250/350 €",
    camouflageNote: "150 € — малая зона · 250 € — средняя зона · 350 € — большая зона",
    correctionNote: "Коррекция через 4-6 недель: 50% от стоимости первичной процедуры",
    correctionNoteShort: "Коррекция через 4-6 недель",
    ...
    contactWhatsapp: "WhatsApp",
    contactEmail: "Email",
    address: "Englmannstraße 2, Büro 1A, 81673 Мюнхен",
    contactTreatment: "Процедуры по предварительной записи",
    contactPostal: "Почтовый адрес",
    postalAddress: "Aubinger Straße 147, 81243 Мюнхен",
    instagram: "Instagram",
    ...
    scalpPrice: "Цена: 250/350 €",
    scalpPriceNote: "250 € — средняя зона · 350 € — большая зона",
    ...
    camouflagePrice: "Цена: 150/250/350 €",
    camouflagePriceNote: "150 € — малая зона · 250 € — средняя зона · 350 € — большая зона",
    ...
    touchupServiceBrowsPrice: "50% от стоимости процедуры",
    touchupServiceLips: "Акварельные / Бархатные / Омбре губы",
    touchupServiceLipsPrice: "50% от стоимости процедуры",
    touchupServiceScalp: "Пигментация кожи головы",
    touchupServiceScalpPrice: "50% от стоимости процедуры",
