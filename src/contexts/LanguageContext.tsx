...
const translations = {
  DE: {
    ...
    scalpPriceNote: "Preis variiert je nach Behandlungsumfang",
    ...
    camouflagePriceNote: "Preis variiert je nach Behandlungsumfang",
  ...
  RU: {
    ...
    scalpPriceNote: "Цена зависит от объёма процедуры",
    ...
    camouflagePriceNote: "Цена зависит от объёма процедуры",
